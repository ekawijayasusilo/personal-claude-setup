# About Section Templates (Job Seekers)
...
```text
Staff software engineer shipping AI-native B2B products from zero to scale. Six years: RAG search at a startup, agentic workflows at Series C. Now looking for a deep-IC staff/principal role — engineering depth, not headcount.

What I've shipped:
- Cut p95 latency 68% on a multi-tenant retrieval pipeline (3.2M docs)
- Designed and shipped the agent orchestration layer that now drives 40% of platform revenue
- Mentored 6 mid-level engineers; three promoted within 18 months

What I'm looking for: a staff/principal IC role at a Series B-D company building AI-native products. I care about engineering depth, tight feedback loops, and writing code other engineers respect. Open to remote (US/EU) or NYC on-site.

Outside work: trail runner, decent home cook, terrible at chess.

Specialties: Python, TypeScript, RAG, agentic systems, distributed systems, observability, mentorship, technical writing, multi-tenant architecture.

Portfolio + writing: [link]
Open to chats about staff IC roles: [email]
```
